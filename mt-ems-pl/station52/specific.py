...
PREVIOUS_OPERATION_NUMBERS = None
...
def initialize(caller):
    ...
    global PREVIOUS_OPERATION_NUMBERS
    ...
    PREVIOUS_OPERATION_NUMBERS = caller.SPECIFIC_CONFIG["previous_operation_numbers"]
...
def check_part(sensor, uid, schema, **kwargs):
    ...
    return not (
        previous_operation_number in PREVIOUS_OPERATION_NUMBERS
        and previous_operation_estatus == "GOOD"
        and operation_ecount < NUMBER_OF_CYCLES
    )
