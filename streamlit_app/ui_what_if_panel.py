...
div[data-testid="stMainBlockContainer"] div.st-key-what_if_cfg_card
[data-testid="stVerticalBlockBorderWrapper"] {
    padding: 0.65rem 0.85rem 0.7rem 0.85rem !important;
    box-sizing: border-box !important;
    font-family: "Barlow Condensed", "Segoe UI", sans-serif !important;
    margin-bottom: 0.85rem !important;
}
div[data-testid="stMainBlockContainer"] div.st-key-what_if_cfg_card label {
    font-family: "Barlow Condensed", "Segoe UI", sans-serif !important;
    font-size: """ + str(_FONT_L3_PX) + """px !important;
}
div[data-testid="stMainBlockContainer"] div.st-key-what_if_cfg_card
...
div[data-testid="stMainBlockContainer"] div.st-key-what_if_charts_card
[data-testid="stVerticalBlockBorderWrapper"] {
...
def _chart_placeholder(title: str) -> None:
    ...
    st.markdown(
        (
            "<div style='min-height:{h}px;height:{h}px;display:flex;align-items:center;"
            "justify-content:center;background:#f8fafc;border:1px dashed {border};"
            "border-radius:8px;'>"
...
def render_what_if_panel() -> None:
    ...
    with st.container(border=True, key="what_if_cfg_card"):
        _cfg_heading()
    ...
    with st.container(border=True, key="what_if_charts_card"):
